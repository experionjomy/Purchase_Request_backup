    ...
    if(this.readyState=='4' && this.status=='200')
    {
        ...
        result=JSON.parse(result);
          //  console.log(result[0]);
            ...
            content = "<form><div class='table table-responsive'><table class='table' id='table1'><thead><tr><th>No.</th><th>Received Date</th><th>Purchase Title</th><th>View More</th></tr></thead><tbody>";
        var i = 1;
        ...
        result.forEach(function(element) {
          ...
          //  console.log(content);
            ...
            content += "<tr><td>" + i + "</td><td>" + element.Created_date + "</td><td>" + element.Purchase_title + "</td><td><button id='viewmore' type='button' onclick='return displayItem("+element.Purchase_id+");'>VIEW MORE</button></td></tr>"  ;
        ...
        content += "</tbody> </table><button type='button'> SAVE </button> </div></form>";
