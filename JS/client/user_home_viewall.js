...
var httpObject=new XMLHttpRequest();
    ...
    if(this.readyState=='4' && this.status=='200')
    {
        ...
        result=JSON.parse(result);
            ...
            content = "<div class='table table-responsive'><table class='table' id='table1'><thead><tr><th>No.</th><th>Purchase Title</th><th>Status</th><th>Created_date</th><th>View More</th></tr></thead><tbody>";
        var i = 1;
        result.forEach(function(element) {
            console.log(content);
            content += "<tr><td>" + i + "</td><td>" + element.Purchase_title + "</td><td>" + element.Status + "</td><td>" + element.Created_date+"</td><td>"+"<button id='viewmore' onclick='displayItem("+element.Purchase_id+");'>View More</button>" +"</td></tr>" ;
